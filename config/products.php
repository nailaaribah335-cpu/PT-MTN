...
return [
    ...
    'items' => [
        ...
        [
            ...
            'image' => 'https://images.unsplash.com/photo-1621252179027-94459d278660?auto=format&fit=crop&w=600&q=80', // placeholder
            'is_best_seller' => false,
        ],
        [
            'id' => 'sepatu-safety',
        ...
        [
            'id' => 'hand-tools-set',
            'category' => 'safety', // Kita kelompokkan ke safety/penunjang
        ...
        [
            ...
            'image' => 'https://images.unsplash.com/photo-1587293852726-591eb345d3c7?auto=format&fit=crop&w=600&q=80', // warehouse placeholder
            'is_best_seller' => true,
        ],
        [
            'id' => 'stretch-film',
            ...
            'image' => 'https://images.unsplash.com/photo-1589939705384-5185137a7f0f?auto=format&fit=crop&w=600&q=80', // packaging placeholder
            'is_best_seller' => true,
        ],
        [
            'id' => 'lakban-isolasi',
            'category' => 'atk', // Lebih cocok ke ATK / penunjang
        ...
        [
            ...
            'image' => 'https://images.unsplash.com/photo-1527515637-64213d2fbbd2?auto=format&fit=crop&w=600&q=80', // mop
            'is_best_seller' => false,
        ],
        [
            'id' => 'ember-pel',
            ...
            'image' => 'https://images.unsplash.com/photo-1618698188167-28d116c2c9d2?auto=format&fit=crop&w=600&q=80', // cleaning bucket
            'is_best_seller' => false,
        ],
        [
            'id' => 'kantong-sampah',
